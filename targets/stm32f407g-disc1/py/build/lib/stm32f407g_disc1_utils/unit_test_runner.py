...
# the License.
"""This script flashes and runs unit tests on stm32f407g-disc1 boards."""
...
import coloredlogs
import serial
from stm32f407g_disc1_utils import stm32f407g_detector
...
def run_device_test(binary,
    ...
    if stlink_serial is None and port is None:
        ...
        boards = stm32f407g_detector.detect_boards()
        if not boards:
